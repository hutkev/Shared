...
module testutils {
  ...
  export function unique(test) {
    ...
    test.ok(utils.isUID('123456781234567812345678'));
    test.ok(!utils.isUID('23456781234567812345678'));
    test.ok(!utils.isUID('1123456781234567812345678'));
    test.ok(utils.isUID('ABCDEF78ABCDEF78ABCDEF78'));
    test.ok(!utils.isUID('ABCDEFG7ABCDEFG7ABCDEFG7'));
