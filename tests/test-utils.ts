...
exports.clog_empty = function(test) {
  var to = new StringWritable();
  var clog = new utils.Logger(to, utils.LogLevel.INFO, ['foo']);
  test.ok(to.lines()===0);
  test.done();
};

exports.clog_debug_one_subject = function(test) {
  var to = new StringWritable();
  var clog = new utils.Logger(to, utils.LogLevel.INFO, ['foo']);
  ...
  test.ok(utils.isEqual(line.substr(25), 'INFO foo: Hello foo\n'));
  var line = to.line(1);
  test.ok(datePat.test(line.substr(0, 25)));
  test.ok(utils.isEqual(line.substr(25), 'INFO Hello bar\n'));

  test.done();
};

exports.clog_debug_two_subject = function(test) {
  var to = new StringWritable();
  var clog = new utils.Logger(to, utils.LogLevel.INFO, ['foo','bar']);
  clog.debug('foo', 'Hello %s','foo');
  clog.debug('bar', 'Hello %s','bar');
  ...
  var line = to.line(1);
  test.ok(datePat.test(line.substr(0, 25)));
  test.ok(utils.isEqual(line.substr(25), 'INFO bar: Hello bar\n'));
  test.done();
};

exports.clog_no_debug = function(test) {
  var to = new StringWritable();
  var clog = new utils.Logger(to, utils.LogLevel.WARN, ['foo','bar']);
  clog.debug('foo', 'Hello %s','foo');
  clog.debug('bar', 'Hello %s','bar');
  clog.debug('bob', 'Hello %s','bob');
...
exports.clog_warn = function(test) {
  var to = new StringWritable();
  var clog = new utils.Logger(to, utils.LogLevel.WARN, []);
  ...
  var line = to.line(0);
  test.ok(datePat.test(line.substr(0, 25)));
  test.ok(utils.isEqual(line.substr(25), 'WARNING Hello foo\n'));
  var line = to.line(1);
  test.ok(datePat.test(line.substr(0, 25)));
  test.ok(utils.isEqual(line.substr(25), 'WARNING Hello bar\n'));
  test.done();
};

exports.clog_fatal = function(test) {
  var to = new StringWritable();
  var clog = new utils.Logger(to, utils.LogLevel.INFO, []);
  ...
  var line = to.line(0);
  test.ok(datePat.test(line.substr(0, 25)));
  test.ok(utils.isEqual(line.substr(25), 'FATAL Hello bob\n'));
  test.done();
};

exports.hashString = function(test) {
...
exports.typetest = function (test) {
...
exports.unique = function (test) {
  ...
  test.ok(u.id() == u.id());
  test.ok(utils.isUID(u.id().toString()));
  test.ok(!utils.isUID(null));
  test.ok(!utils.isUID(''));
  test.ok(!utils.isUID('a'));
  test.ok(utils.isUID('12345678-1234-1234-1234-123456789012'));
  test.ok(!utils.isUID('2345678-1234-1234-1234-123456789012'));
  test.ok(!utils.isUID('12345678-234-1234-1234-123456789012'));
  test.ok(!utils.isUID('12345678-1234-234-1234-123456789012'));
  test.ok(!utils.isUID('12345678-1234-1234-234-123456789012'));
  test.ok(!utils.isUID('12345678-1234-1234-1234-23456789012'));
  test.ok(utils.isUID('ABCDEF78-1234-1234-1234-123456789012'));
  test.ok(!utils.isUID('BCDEFG78-234-1234-1234-123456789012'));
  var u2 = new utils.UniqueObject();
  test.ok(u2.id() === u2.id());
  test.ok(utils.isUID(u2.id().toString()));
  test.ok(u2 !== u);
  var u3 = new utils.UniqueObject();
  test.ok(u3.id() === u3.id());
  test.ok(utils.isUID(u3.id().toString()));
  test.ok(u3 !== u);
  test.ok(u3 !== u2);
  test.done();
}

exports.stringmap = function (test) {
...
exports.stringset = function (test) {
